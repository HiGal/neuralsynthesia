...
module.exports = function (audioContext, stream, opts, onResult) {
    ...
    function init() {
        ...
        var averageEnvFreq = envFreqRange.length ? envFreqRange.reduce(function (p, c) {
            return Math.min(p, c)
        }, 1) : (options.minNoiseLevel || 0.1);
